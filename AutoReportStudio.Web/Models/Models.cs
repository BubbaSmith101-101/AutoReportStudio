...
public class ReportResult { public string Title { get; set; } = "Generated Report"; public string Summary { get; set; } = ""; public DateTime GeneratedUtc { get; set; } = DateTime.UtcNow; public List<ReportSection> Sections { get; set; } = new(); public long ProcessingTimeMs { get; set; } = 0; public long TokensGenerated { get; set; } = 0; public long TimeToFirstTokenMs { get; set; } = 0; public string ModelUsed { get; set; } = ""; }
